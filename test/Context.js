...
{
   test('should return a valid instance of Context', function(assert)
   {
      var context = new Four.Context({ selector: '#test' });

      assert.strictEqual(Four.Context.prototype.constructor.name, 'Context', 'Passed: Context class is available.');
